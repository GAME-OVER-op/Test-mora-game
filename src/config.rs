...
pub const POLICY0_GOV: &str = "/sys/devices/system/cpu/cpufreq/policy0/scaling_governor";
pub const POLICY2_GOV: &str = "/sys/devices/system/cpu/cpufreq/policy2/scaling_governor";
pub const POLICY5_GOV: &str = "/sys/devices/system/cpu/cpufreq/policy5/scaling_governor";
